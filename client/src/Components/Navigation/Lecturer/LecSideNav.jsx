  ...
  return (
    <div>
      ...
      <div className="middle-content">
        ...
        <div className="sidenav_link"><Link to="mark_attendance"><IoIosPeople /> &nbsp; Student Attendance</Link></div>
        <div className="sidenav_link"><Link to="change_password"><PiStudentBold /> &nbsp; Student Grades</Link></div>
        <div className="sidenav_link"><Link to="change_password">< BsBookFill/> &nbsp; View Logins</Link></div>
      </div>
    </div>
  );
};
