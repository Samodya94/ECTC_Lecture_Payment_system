...
// Styles
import styles from "./paymentRollbackTable.module.css";
...
const TableComponent = ({ rows, columns }) => {
  ...
  const updatePayment = (id) => {
    ...
    response
      .then((res) => {
        alert("Payment Rolledback Successfully");
              ...
              {columns.map((column, index) => (
                <TableCell
                  ...
                  style={{
                    ...
                    width: index === 0 ? "14.5%" : index === 2 ? "9%" : index === 3 ? "8%" : index === 7 ? "9%" : index === 8 ? "9.5%" : index === 9 ? "11%" : "auto",
                  }}
                >
